...
fileName = 'BendValenti'  # Also Type_2.2
fileOverwrite = 0 
GCodeWrite = 1        # 1 = write Gcode to File, 0 = Do not
SCADWrite  = 0        # 1 = write Full OpenSCAD File (contains everything
...
# Define Wing Span & Aspect Ratio
# b       = 1220          # Wingspan [mm]
# AR      = 8            # Aspect Ratio

# Define Wing Area & Aspect Ratio
S       = 0.149  # Wing Area [m^2]
AR      = 8           # Aspect Ratio
b = (AR*S)**(0.5)*1000

# n       = 400       # Spanwise Discretization
n       = 1000       # Spanwise Discretization
...
# from CodeFiles.Aerodynamics.Airfoils.PSU94097 import *
...
if WingType == 2.2:
    ...
    # # planform =  0.6
    # liftShape = 'e'
    # clShape = [[-0.5,1.1],[0.0,1.4],[0.5,1.1]]
...
# dxLim = 40   # max spar spacing mm
dxLim = 1000   # Constant DxLim
# dxDfAM = [2e-5,60]   # adaptive spar constraint, [0] = eta*, [1] = r*
dxDfAM = [3e-5,45]   # adaptive spar constraint, [0] = eta*, [1] = r*
"""
