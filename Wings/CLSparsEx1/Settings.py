...
fileName = 'CLSparsEx1'   # direct design
fileOverwrite = 0 
...
n       = 50     # Spanwise Discretization
b       = 1000          # Wingspan [mm]
# b       = 2000          # Wingspan [mm]
AR      = 8            # Aspect Ratio
pLL_AF  = [1.0,1.0]    # pos of LL on root wing section, [x/c,z/t]
P       = 0.3*9.8         # Non-structural Weight [N]
rho     = 1.225         # Air Density [kg/m3]

# # Pmass   = 1         # (kg) Total non-structural weight
# fuseW   = 70/b      # width of fuse, frac of span
# # fuseW   = 1/b      # width of fuse, frac of span
...
# b = (AR*S)**(0.5)*1000
# Pmass   = 1         # (kg) Total non-structural weight
fuseW   = 0.01      # width of fuse, frac of span
fuseY   = 0.0       # location of fuse center, frac of span, center = 0, LWT = -0.5, RWT = 0.5
rho_m   = 1.24*1000 # (kg/m^3) PLA density 
sigma_y = 26e6      # (Pa) yield stress PLA
...
from CodeFiles.Aerodynamics.Airfoils.CubeRootAF import *
...
Select a Wing Type:
        ...
        1.1 = Given Lift and Twist, Solve Chord [NOT IMPLEMENTED YET]
...
if WingType == 2.2:
    cL1   = 0.5      # cL for aerodynamic performance
    cLstruct = 1.2      # cL for structural sizing
    # planform =  0.6
    liftShape = 'e'
...
tipLoaded = 1 # 1 = design structure for tip loading only
accountSkinWeight = 0
skinStructConsider = 0
# dxLim = 30   # max spar spacing mm
dxLim = 1000   # Constant DxLim
# dxDfAM = [2e-5,50]   # adaptive spar constraint, [0] = eta*, [1] = r*
dxDfAM = [2e-5,50]   # adaptive spar constraint, [0] = eta*, [1] = r*
"""
